defmodule Bombero.GameState do
  ...
  defstate set_30 do
    defevent choose(:set_30_option_1), data: data do
      data = add_set_30_flags(data)
      next_state(:set_31, data)
    end

    defevent choose(:set_30_option_2), data: data do
      data = add_set_30_flags(data)
      next_state(:set_34, data)
    end
  end

  defp add_set_30_flags(data) do
  ...
  defstate set_34 do
    ...
    defevent choose(:set_34_option_2), data: data do
      data = add_set_34_flags(data)
      next_state(:set_39, data)
    end
  end

  defp add_set_34_flags(data) do
